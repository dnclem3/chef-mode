    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 container mx-auto px-4 py-12 flex flex-col items-center justify-center max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mb-12">
          ...
          <div className="flex flex-col items-center text-center p-4">
            <div className="h-12 w-12 rounded-full flex items-center justify-center mb-4 bg-muted-foreground">
              <span className="font-semibold text-white">3</span>
            </div>
            <h3 className="font-medium text-lg mb-2">Save your favorites</h3>
            <p className="text-muted-foreground">Create an account to save recipes for quick access later</p>
          </div>
        </div>
        ...
        <div className="bg-muted rounded-lg p-6 w-full">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3">
              <ArrowRight className="h-5 w-5 mt-0.5 flex-shrink-0 text-black" />
              <span>Built-in timers exactly when you need them</span>
            </li>
            <li className="flex items-start gap-3">
              <ArrowRight className="h-5 w-5 mt-0.5 flex-shrink-0 text-black" />
